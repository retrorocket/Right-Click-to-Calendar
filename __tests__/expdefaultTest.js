...
test("デフォルト正規表現テスト_月が英語表記_US1", () => {
  localStorage.removeItem("detailSwitch");
  expect(expDefault("September 14 2020 28:45　テスト\n場所 あいうえお\nOct. 2nd, 2022 28:48")).toStrictEqual(
    {
      "detail": "",
      "start": {
        "tf": true,
      ...
      "title": "テスト",
      "location": "あいうえお",
      "selected_text": "September 14 2020 28:45　テスト\n場所 あいうえお\nOct. 2nd, 2022 28:48",
    }
  )
});
...
test("デフォルト正規表現テスト_月が英語表記_US2", () => {
  localStorage.removeItem("detailSwitch");
  expect(expDefault("Sep 14, 2020 28:45　テスト\n場所 あいうえお\nOct. 2, 2022 28:48")).toStrictEqual(
    {
      "detail": "",
      "start": {
        "tf": true,
      ...
      "title": "テスト",
      "location": "あいうえお",
      "selected_text": "Sep 14, 2020 28:45　テスト\n場所 あいうえお\nOct. 2, 2022 28:48",
    }
  )
});
...
test("デフォルト正規表現テスト_月が英語表記_EN1", () => {
  localStorage.removeItem("detailSwitch");
  expect(expDefault("14 September 2020 28:45　テスト\n場所 あいうえお\n2nd Oct., 2022 28:48")).toStrictEqual(
    {
      "detail": "",
      "start": {
        "tf": true,
      ...
      "title": "テスト",
      "location": "あいうえお",
      "selected_text": "14 September 2020 28:45　テスト\n場所 あいうえお\n2nd Oct., 2022 28:48",
    }
  )
});
...
test("デフォルト正規表現テスト_月が英語表記_EN2", () => {
  localStorage.removeItem("detailSwitch");
  expect(expDefault("14 Sep, 2020 28:45　テスト\n場所 あいうえお\n2 Oct., 2022 28:48")).toStrictEqual(
    {
      "detail": "",
      "start": {
        "tf": true,
      ...
      "title": "テスト",
      "location": "あいうえお",
      "selected_text": "14 Sep, 2020 28:45　テスト\n場所 あいうえお\n2 Oct., 2022 28:48",
    }
  )
});
